...
hl(0, 'WhichKey',                     { bg = '#1d2021' })
hl(0, 'WhichKeyGroup',                { fg = '#d3869b', bg = '#1d2021' })
hl(0, 'WhichKeySeparator',            { fg = '#bdae93', bg = '#1d2021' })
hl(0, 'WhichKeyDesc',                 { fg = '#83a598', bg = '#1d2021' })
hl(0, 'WhichKeyFloat',                { fg = '#ebdbb2', bg = '#1d2021' })
hl(0, 'WhichKeyBorder',               { fg = '#1d2021', bg = '#1d2021' })
hl(0, 'WhichKeyValue',                { bg = '#1d2021' })
hl(0, 'WhichKeyIcon',                 { bg = '#1d2021' })
hl(0, 'WhichKeyNormal',               { bg = '#1d2021' })
hl(0, 'WhichKeyTitle',                { bg = '#1d2021' })
