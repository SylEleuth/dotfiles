  ...
  {"items":
   [("wm.call_menu_pie",
    ...
    ("wm.call_menu_pie",
     ...
     {"properties":
      [("name", 'WAZOU_RMB_PIE_MENUS_MT_menu'),
       ],
      },
     ),
    ("wm.call_menu_pie",
    ...
    ("sfc.modifiers_popup", {"type": 'QUOTE', "value": 'PRESS'}, None),
    ("wm.context_toggle",
     {"type": 'T', "value": 'PRESS'},
     {"properties":
  ...
  {"items":
   [("object.booltool_auto_slice", {"type": 'NUMPAD_SLASH', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ...
    ("wm.call_menu_pie",
     {"type": 'A', "value": 'PRESS'},
     {"properties":
      [("name", 'WAZOU_PIE_MENUS_MT_selection_object_mode'),
       ],
    "active":False,
      },
     ),
    ("wm.call_menu_pie",
     ...
     {"properties":
      [("name", 'WAZOU_PIE_MENUS_MT_apply_clear_transforms'),
       ],
      },
     ),
    ("wm.call_menu_pie",
    ...
    ("object.select_hierarchy", {"type": 'LEFT_BRACKET', "value": 'PRESS'}, None),
    ("object.select_hierarchy", {"type": 'LEFT_BRACKET', "value": 'PRESS', "shift": True}, None),
    ("object.select_hierarchy", {"type": 'RIGHT_BRACKET', "value": 'PRESS'}, None),
    ("object.select_hierarchy", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "shift": True}, None),
  ...
  {"items":
   [("mesh.f2", {"type": 'F', "value": 'PRESS'}, None),
    ...
    ("wm.call_menu_pie",
     {"type": 'A', "value": 'PRESS'},
     {"properties":
      [("name", 'WAZOU_PIE_MENUS_MT_selection_edit_mode'),
       ],
    "active":False,
      },
     ),
    ("wm.call_menu_pie",
     {"type": 'X', "value": 'PRESS'},
     {"properties":
      [("name", 'WAZOU_PIE_MENUS_MT_delete'),
       ],
      },
     ),
    ("mesh.loopcut_slide",
 ...
 ("3D View",
  ...
  {"items":
   [("carver.operator", {"type": 'X', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ...
    ("object.fc_circle_array_mode_op", {"type": 'C', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("object.fc_array_mode_op", {"type": 'A', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("object.fc_immediate_mode_op", {"type": 'P', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("wm.call_menu_pie",
     {"type": 'S', "value": 'PRESS', "shift": True},
     {"properties":
      [("name", 'WAZOU_PIE_MENUS_MT_origin_pivot'),
       ],
      },
     ),
    ("wm.call_menu_pie",
    ...
    ("wm.call_menu_pie",
     {"type": 'C', "value": 'PRESS'},
     {"properties":
      [("name", 'WAZOU_PIE_MENUS_MT_active_tools'),
       ],
      },
     ),
    ("wm.call_menu_pie",
     ...
     {"properties":
      [("name", 'WAZOU_PIE_MENUS_MT_snapping'),
       ],
    "active":False,
      },
     ),
