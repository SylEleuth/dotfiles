...
class MESH_OT_edgeequalizeaverageoperator(EdgeEqualizeBase):
...
class MESH_OT_edgeequalizeshortestoperator(EdgeEqualizeBase):
...
class MESH_OT_edgeequalizelongestoperator(EdgeEqualizeBase):
...
class MESH_OT_edgeequalizeactiveoperator(EdgeEqualizeBase):
...
CLASSES =  [MESH_OT_edgeequalizeactiveoperator,
            MESH_OT_edgeequalizelongestoperator,
            MESH_OT_edgeequalizeshortestoperator,
            MESH_OT_edgeequalizeaverageoperator]
