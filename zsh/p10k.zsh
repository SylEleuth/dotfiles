# Generated by Powerlevel10k configuration wizard on 421-04-06 at 4:34 BST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 4492.
...
() {
  ...
  # typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%4F├─'
  # typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{4}\u2570%F{4}\uF460%F{4}'
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%236F\uE0B0'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%236F\uE0B2'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=6
  ...
  local vcs=''
  # If on a branch...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%10F'${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}
  ...
  vcs+=':-${VCS_STATUS_LOCAL_BRANCH[1,12]//\%/%%}%2F…%10F${VCS_STATUS_LOCAL_BRANCH[-12,-1]//\%/%%}}}'
  # '@72f5c8a' if not on a branch.
  vcs+=':-%8F@%101010101010101010101010F${VCS_STATUS_COMMIT[1,8]}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+%8F:%10F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+%8F#%10F${VCS_STATUS_TAG//\%/%%}}'
  # ⇣42 if behind the remote.
  vcs+='${${VCS_STATUS_COMMITS_BEHIND:#0}:+ %10F⇣${VCS_STATUS_COMMITS_BEHIND}}'
  # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
  # If you want '⇣42 ⇡42' instead, replace '${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }' with ' '.
  vcs+='${${VCS_STATUS_COMMITS_AHEAD:#0}:+${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }%10F⇡${VCS_STATUS_COMMITS_AHEAD}}'
  # *42 if have stashes.
  vcs+='${${VCS_STATUS_STASHES:#0}:+ %10F*${VCS_STATUS_STASHES}}'
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=1
  ...
  # Load color when load is between 50% and 6%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=3
  # Load color when load is over 6%.
  ...
  #############[ rbenv: ruby version from rbenv (https://github.com/rbenv/rbenv) ]##############
  # Rbenv color.
  typeset -g POWERLEVEL9K_RBENV_FOREGROUND=13
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=13
  ...
  ################[ terraform: terraform workspace (https://www.terraform.io) ]#################
  # Terraform color.
  typeset -g POWERLEVEL9K_TERRAFORM_FOREGROUND=12
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_BATTERY_CHARGING_FOREGROUND=6
  ...
  function prompt_example() {
    p10k segment -f 48 -i '⭐' -t 'hello, %n'
  }

  # User-defined prompt segments can be customized the same way as built-in segments.
  typeset -g POWERLEVEL9K_EXAMPLE_FOREGROUND=48
